...
class Flickr extends A_Engine {
    ...
    public $urls = array(
        ...
        'access_url' => 'https://www.flickr.com/services/oauth/request_token',
        'link' => 'https://api.flickr.com/services/rest/?method=flickr.test.echo&name=value',
    );
